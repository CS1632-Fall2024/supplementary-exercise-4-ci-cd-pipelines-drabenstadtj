...
public class RentACatUnitTest {
	...
	public void testRentCatFailureNumCats3() {
		...
		// First rent the cat with ID 2
		assertTrue(r.rentCat(2)); // First rent attempt should succeed
		Mockito.verify(c2).rentCat(); // Verify that rentCat() was called

		// Now, mock that the cat is rented out
		when(c2.getRented()).thenReturn(true);

		// Attempt to rent the same cat again, should fail
		assertFalse(r.rentCat(2)); // Second rent attempt should fail
